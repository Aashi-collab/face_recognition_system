...
#year
        ...
        year_combo["values"]=("select year","2023-2024","2024-2025","2025-2026")
...
#========search system========
        ...
        search_btn = Button(Search_frame, text="Search", width=9, font=("times of roman", 12, "bold"), bg="blue" ,fg = "white")
        search_btn.grid(row=0, column=3, padx=2)

        showAll_btn = Button(Search_frame, text="Show All", width=9, font=("times of roman", 12, "bold"), bg="blue" ,fg = "white")
        showAll_btn.grid(row=0, column=4, padx=2)

#table frame
        table_frame = Frame(Right_frame, bd=2, bg="white", relief=RIDGE)
        table_frame.place(x=5, y=210, width=645, height=350)
